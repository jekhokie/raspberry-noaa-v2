...
# Title: Airspy Mini NOAA APT Receiver V1.0.0
# Author: Mihajlo
...
class airspy_mini_noaa_apt_rx(gr.top_block):

    def __init__(self):
        gr.top_block.__init__(self, "Airspy Mini NOAA APT Receiver V1.0.0")
        ...
        self.osmosdr_source_0 = osmosdr.source(
            args="numchan=" + str(1) + " " + "airspy=0" + ",bias=" + bias_t + ""
        )
...
def main(top_block_cls=airspy_mini_noaa_apt_rx, options=None):
    tb = top_block_cls()
