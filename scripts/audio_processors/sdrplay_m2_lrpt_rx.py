...
# Title: SDRPlay Meteor QPSK LRPT
# Author: Mihajlo
...
class sdrplay_m2_lrpt_rx(gr.top_block):

    def __init__(self):
        gr.top_block.__init__(self, "SDRPlay Meteor QPSK LRPT")
        ...
        self.blocks_wavfile_sink_0 = blocks.wavfile_sink('baseband.wav', 2, int(samp_rate_hackrf/decim), 16)
...
def main(top_block_cls=sdrplay_m2_lrpt_rx, options=None):
    tb = top_block_cls()
