...
*  **[mihajlo2003petkovic](https://github.com/mihajlo2003petkovic)**: Updates to the web browser and general updating and debugging.I've just noticed it. Integrated MeteorDemod in `receive_meteor.sh` and shrunk code quite a bit in `receive_noaa.sh`.
## Contributing
