...
return array(
  ...
  "run_git_checkout_tag_txt" => "Use a defined tag - if 'LATEST' is shown, you are already on the latest available tagged version",
  "run_git_pull_latest" => "Git Pull Latest",
  "run_git_pull_latest_txt" => "Pull the latest code (edge) available in the master branch.",
