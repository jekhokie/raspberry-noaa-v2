  ...
  public function getEnhancements($id) {
    ...
    switch($pass['sat_type']) {
      ...
      case 1: // NOAA
        ...
        $satdump_enhancements = ["-APT-A.jpg", "-APT-B.jpg", "-raw.jpg", "-A_individual_equalized.jpg", "-B_individual_equalized.jpg", "-Clouds_Underlay.jpg", "-224.jpg", "-MCIR.jpg", "-MCIR_map.jpg", "-MCIR_Rain.jpg", "-MCIR_Rain_map.jpg", "-MSA.jpg", "-MSA_map.jpg", "-WXtoImg_HVC_N15.jpg", "-WXtoImg_HVC_N18.jpg", "-WXtoImg_HVC_N19.jpg", "-WXtoImg_NO.jpg"];
